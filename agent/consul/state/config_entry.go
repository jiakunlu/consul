...
func validateProposedConfigEntryInGraph(
	...
	case structs.IngressGateway:
		...
		err = validateProposedIngressProtocolsInServiceGraph(tx, next)
		if err != nil {
			return err
		}
...
func validateProposedConfigEntryInServiceGraph(
	...
	for chain := range checkChains {
		if err := testCompileDiscoveryChain(tx, chain.ID, overrides, &chain.EnterpriseMeta); err != nil {
			return err
		}
	}
...
func validateProposedIngressProtocolsInServiceGraph(tx ReadTxn, next structs.ConfigEntry) error {
